...
static const struct ieee80211_regdomain regdom_AL = {
	...
	.reg_rules = {
		...
		REG_RULE_EXT(5490, 5730, 160, 0, 30, 0, 
			NL80211_RRF_DFS | 0),
		REG_RULE_EXT(5735, 5875, 80, 0, 14, 0, 0),
	},
	.n_reg_rules = 5
};
...
static const struct ieee80211_regdomain regdom_IN = {
	...
	.reg_rules = {
		...
		REG_RULE_EXT(5490, 5730, 160, 0, 24, 0, 
			NL80211_RRF_DFS | 0),
		REG_RULE_EXT(5735, 5875, 80, 0, 30, 0, 0),
	},
	.n_reg_rules = 5
};
...
static const struct ieee80211_regdomain regdom_QA = {
	...
	.reg_rules = {
		...
		REG_RULE_EXT(5490, 5730, 80, 0, 20, 0, 
			NL80211_RRF_DFS | 0),
		REG_RULE_EXT(5735, 5875, 80, 0, 20, 0, 0),
	},
	.n_reg_rules = 5
};
...
static const struct ieee80211_regdomain regdom_SA = {
	...
	.reg_rules = {
		...
		REG_RULE_EXT(5735, 5835, 80, 0, 30, 0, 
			NL80211_RRF_DFS | 0),
	},
	.n_reg_rules = 4
};
...
static const struct ieee80211_regdomain regdom_TG = {
	...
	.reg_rules = {
		REG_RULE_EXT(2402, 2482, 40, 0, 20, 0, 0),
		REG_RULE_EXT(5170, 5250, 40, 0, 23, 0, 
			NL80211_RRF_NO_OUTDOOR | 0),
		REG_RULE_EXT(5250, 5330, 40, 0, 23, 0, 
			NL80211_RRF_NO_OUTDOOR | 
			NL80211_RRF_DFS | 0),
